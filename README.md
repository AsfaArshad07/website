...
<html lang="en">
  ...
  <body>
    ...
    <!--Navbar end-->
       ...
       <!--header img-->
    <div class="aboutheader " data-aos="zoom-out-up">
      <img src="images/about head.jpg" alt="">
    </div>
    ...
    <section class="banner_wrapper">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 header-img-section">
                    <img src="images/about-four-img-1.jpg" alt="banner" class="img-fluid">
                </div>
                <div class="col-md-6 my-md-0 text-center text-md-start">
                    <p class="banner-subtitle">ABOUT COMPANY</p>
                    <h1 class="banner-title">Creating a better future for your loved once</h1>
                    <p class="banner-title-text">Only our company gives you an investment with your life <br> insurance policy at no extra cost</p>
                </div>
            </div>
        </div>
  ...
  <!--header img end-->
   ...
   <!--Brand slider start-->
                ...
                <div class="brand_container">
                    <h2 class="brandh2">Trusted and funded by more then <br> 800 companies</h2>
                    <section class="brand_logo slider">
                        <div class="slide">
                            <img src="images/brand1.png" alt="" style="width: 50%; height: 70px;">
                        </div>
                        <div class="slide">
                            <img src="images/brand 2.png" alt="" style="width: 50%; height: 70px;">
                        </div>
                        <div class="slide">
                            <img src="images/brand 3.png" alt=""style="width: 50%; height: 70px;">
                        </div>
                        <div class="slide">
                            <img src="images/brand 4.png" alt="" style="width: 50%; height: 70px;">
                        </div>
                        <div class="slide">
                            <img src="images/brand 5.png" alt="" style="width: 50%; height: 70px;">
                        </div>
                        <div class="slide">
                            <img src="images/brand 3.png" alt=""style="width: 50%; height: 70px;">
                        </div>
              ...
              <!--Brand slider end-->
                 ...
                 <div class="teamheading">
                  <p class="teampp">Our Team Members</p>
                 </div>
                  ...
                  <div class="team_container">
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="our-team">
                                <div class="pic">
                                    <img src="images/asfa.jpg" alt="" class="img-fluid" >
                                </div>
                                <div class="content-team">
                                    <h3 class="team-title">Asfa Arshad</h3>
                                    <span class="post">Web Develepor</span>
                                    <ul class="team-social">
                                        ...
                                        <li><a href="https://www.linkedin.com/login" class="fa fa-linkedin-square"></a></li>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="our-team active">
                                <div class="pic">
                                    <img src="images/laiba.jpeg" alt="" class="img-fluid " >
                                </div>
                                <div class="content-team">
                                    <h3 class="team-title">Laiba Najeeb</h3>
                                    <span class="post">Web Develepor</span>
                                    <ul class="team-social">
                                        <li><a href="https://www.facebook.com/" class="fa fa-facebook-square"></a></li>
                                        <li><a href="https://twitter.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoiZW4ifQ%3D%3D%22%7D" class="fa fa-twitter"></a></li>
                        ...
                        <div class="col-md-4 col-sm-8">
                            <div class="our-team">
                                <div class="pic">
                                    <img src="muslim-hijab-girl-illustration-vector.jpg" alt="" class="team-img-fluid">
                                </div>
                                <div class="content-team">
                                    <h3 class="team-title">Areeba Shah</h3>
                                    <span class="post">Web Develepor</span>
                                    <ul class="team-social">
                                        <li><a href="https://www.facebook.com/" class="fa fa-facebook-square"></a></li>
                                        <li><a href="https://twitter.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoiZW4ifQ%3D%3D%22%7D" class="fa fa-twitter"></a></li>
